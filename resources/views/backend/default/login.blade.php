...
<div class="login-box">
    <div class="login-logo">
        <a href="{{route('yonetim.Login')}}"><b style="color: white">Giriş Yap</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{route('yonetim.Authenticate')}}" method="post">
            @csrf
            <div class="form-group has-feedback">
                <input type="email" required class="form-control" placeholder="Kullanıcı Adı" name="email" value="{{old('email')}}">
