...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="{{route('yonetim')}}" class="logo">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('yonetim.Logout')}}" class="btn btn-default btn-flat">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{route('yonetim')}}"><i class="fa fa-link"></i> <span>Ana Sayfa</span></a></li>
                <li><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> <span>Blog</span></a></li>
                <li><a href="{{route('page.index')}}"><i class="fa fa-paper-plane"></i> <span>Sayfa</span></a></li>

                <li><a href="{{route('slider.index')}}"><i class="fa fa-paper-plane"></i> <span>Slider</span></a></li>
                <li><a href="{{route('about.Detail')}}"><i class="fa fa-paper-plane"></i> <span>Hakkımızda</span></a></li>
                <!--<li><a href=""><i class="fa fa-paper-plane"></i> <span>Misyon</span></a></li>-->
                <li><a href="{{route('contact.Index')}}"><i class="fa fa-paper-plane"></i> <span>İletişim</span></a></li>
