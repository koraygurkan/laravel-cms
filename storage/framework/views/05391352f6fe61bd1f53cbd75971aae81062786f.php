...
<div class="login-box">
    <div class="login-logo">
        <a style="color:white; " href="<?php echo e(route('nedmin.Login')); ?>"><b>NE</b> YAZILIM</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="<?php echo e(route('nedmin.Authenticate')); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="remember_me" <?php echo e(old('remember_me') ? 'checked' : ''); ?>> Beni
                            Hatırla
                        </label>
                    </div>
                </div>
...
<?php /**PATH C:\AppServ\www\ecms\resources\views/backend/default/login.blade.php ENDPATH**/ ?>