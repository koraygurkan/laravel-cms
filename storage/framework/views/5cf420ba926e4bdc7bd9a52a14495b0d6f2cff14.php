...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="<?php echo e(route('yonetim')); ?>" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini"><b>K</b>GD</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>KGD</b> CMS</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?php echo e(auth::User()->name); ?> <small><?php echo e(auth::User()->email); ?></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo e(route('yonetim.Logout')); ?>" class="btn btn-default btn-flat">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="<?php echo e(route('yonetim')); ?>"><i class="fa fa-link"></i> <span>Ana Sayfa</span></a></li>
                <li><a href="<?php echo e(route('blog.index')); ?>"><i class="fa fa-paper-plane"></i> <span>Blog</span></a></li>
                <li><a href="<?php echo e(route('page.index')); ?>"><i class="fa fa-paper-plane"></i> <span>Sayfa</span></a></li>

                <li><a href="<?php echo e(route('slider.index')); ?>"><i class="fa fa-paper-plane"></i> <span>Slider</span></a></li>
                <li><a href="<?php echo e(route('about.Detail')); ?>"><i class="fa fa-paper-plane"></i> <span>Hakkımızda</span></a></li>
                <!--<li><a href=""><i class="fa fa-paper-plane"></i> <span>Misyon</span></a></li>-->
                <li><a href="<?php echo e(route('contact.Index')); ?>"><i class="fa fa-paper-plane"></i> <span>İletişim</span></a></li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2023 <a href="https://koraygurkandanaci.com/" target="_blank">KGD</a>.</strong> Tüm Hakları Saklıdır.
    </footer>
...
</html><?php /**PATH /var/www/vhosts/koraygurkandanaci.com/cms.koraygurkandanaci.com/resources/views/backend/layout.blade.php ENDPATH**/ ?>