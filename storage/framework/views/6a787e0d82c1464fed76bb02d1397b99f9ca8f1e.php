                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $data['user']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="item-<?php echo e($user->id); ?>">
                            <td class="sortable" width="150"><img width="150" src="/images/users/<?php echo e($user->user_file); ?>" alt=""></td>
                            <td><?php echo e($user->name); ?></td>
                            <td width="5"><a href="<?php echo e(route('user.edit',$user->id)); ?>"><i class="fa fa-pencil-square"></i></a></td>
                            <td width="5">
                                <a href="javascript:void(0)"><i id="<?php echo $user->id ?>"
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppServ\www\ecms\resources\views/backend/users/index.blade.php ENDPATH**/ ?>