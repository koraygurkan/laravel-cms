                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $data['blog']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="item-<?php echo e($blog->id); ?>">
                            <td class="sortable"><?php echo e($blog['blog_title']); ?></td>
                            <td width="5"><a href="<?php echo e(route('blog.edit',$blog->id)); ?>"><i class="fa fa-pencil-square"></i></a></td>
                            <td width="5">
                                <a href="javascript:void(0)"><i id="<?php echo $blog->id ?>"
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\AppServ\www\ecms\resources\views/backend/blogs/index.blade.php ENDPATH**/ ?>