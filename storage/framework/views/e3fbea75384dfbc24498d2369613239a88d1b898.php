            ...
            <div class="box-body">
                ...
                <?php if(isset($sliders->slider_file)): ?>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <img src="/images/sliders/<?php echo e($sliders->slider_file); ?>" width="100">
                            </div>
                        </div>
                    </div>
               <?php endif; ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/koraygurkandanaci.com/cms.koraygurkandanaci.com/resources/views/backend/sliders/edit.blade.php ENDPATH**/ ?>